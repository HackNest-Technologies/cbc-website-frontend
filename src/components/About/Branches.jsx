    ...
    <section className="relative pb-[450px] md:pt-[250px] md:pb-[200px] lg:pt-[430px] lg:pb-[400px]">
      <div className="bg-[rgba(255,185,30,0.28)] h-[220px] md:h-[408px] md:py-[67px]">
        <div className="flex flex-col items-center">
          <div className="w-[262px] pt-6 pb-5 md:w-[689px]">
            <h2 className="text-xl text-center font-satoshi font-semibold">
              Explore Our Branches and Fellowships
            </h2>
            <p className="text-sm text-center font-inter text-black/70 pt-[5px] leading-[120%] md:text-base">
        ...
        <div className="flex justify-center gap-8">
          <button
            ...
            className="border rounded-full p-[5px] disabled:opacity-40"
          >
            <FaArrowLeft />
          </button>
          <button
      ...
      <section className="absolute top-[190px] px-6 grid grid-cols-2 gap-5 md:top-[550px] md:flex  md:px-0 md:pl-20">
