...
import giveIcon from "../../assets/images/streamline_give-gift.svg";
import solar from "../../assets/images/solar_share-outline.svg";

const GuestLiveActions = ({ onLiveChatClick, onGiveClick, onShareClick }) => {
  return (
    <section>
      <div className="flex flex-row md:flex-col gap-[8px] md:gap-[11px] w-[237px] h-[47px] md:w-[59px] md:h-[330px] lg:w-[84px] lg:h-[441px]">
        ...
        <div className="flex flex-col items-center gap-[8px] md:gap-[11px] w-[58px] h-[47px] md:w-[60px] md:h-[74px] lg:w-[84px] lg:h-[104px]">
          <div onClick={onLiveChatClick} className="cursor-pointer">
        ...
        <div
          className="flex flex-col items-center justify-center gap-[8px] w-[47.2px] h-[47.4px] md:gap-[11px] md:w-[60px] md:h-[74px] lg:w-[84px] lg:h-[104px] cursor-pointer"
          onClick={onGiveClick}
        >
