      ...
      <section className="text-white flex justify-between md:gap-10 md:lg:gap-0">
        ...
        <div>
          ...
          <ul className="list-none font-inter">
            ...
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/about#branches">
                CBC branches
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="list-none  font-inter">
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/live">
                Live Service{" "}
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/past-sermon">
                Past Sermons{" "}
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/study">
                Daily Devotional{" "}
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base">
            ...
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/house-fellowship">
                House fellowship
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="list-none  font-inter">
            ...
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/#testimonies">
                Testimonies
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/departments-group">
                Departments & Groups
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/welcome">
                New Member’s Corner
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/counselling">
                Counselling
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="list-none  font-inter">
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/membership-class">
                Membership class
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/maturity-class">
                Maturity class
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/ministerial-class">
                Ministerial class
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/mission">
                Missions
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/marriage-class">
                Marriage class
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="list-none font-inter">
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/marriage">
                Marriage
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/thanksgiving">
                Special Thanksgiving
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/baby-dedication">
                Baby Dedication
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/naming">
                Naming ceremony
              </Link>
            </li>
            <li className="md:pt-2 md:text-sm lg:pt-3 lg:text-base ">
              <Link onClick={toggleMenu} to="/deliverance">
                Deliverance
              </Link>
            </li>
          </ul>
