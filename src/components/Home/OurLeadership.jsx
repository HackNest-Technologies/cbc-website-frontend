...
const OurLeadership = () => (
  <section className="container mx-auto p-6 space-y-[32.14px] md:p-0 md:pt-[80px]">
    <h3 className="font-satoshi text-[26.71px] leading-[100%] uppercase sm:text-[40px]">
      Our Leadership
    </h3>

    <div className="bg-[#E5E5E5] py-[14.68px] px-[16px]  rounded-[7.35px] space-y-4 sm:flex sm:flex-row-reverse justify-between md:py-[22px] md:px-[44px] sm:gap-4  md:w-full">
      <div className=" ">
        <img
          src={pastorAndWife}
          alt="Pastor and his wife"
          className=" rounded-[9.18px] md:w-[350.56px] md:h-[381.56px] ] sm:translate-y-[80%] md:translate-y-[65%]"
        />
      </div>

      <div className="space-y-4 sm:space-y-8 flex-1  md:flex flex-col justify-between">
        <h4 className="text-sm leading-[100%] font-satoshi capitalize md:text-base">
          pastor olumide emmanuel
        </h4>
        <p className="text-sm font-inter leading-[120%] md:text-base">
        ...
        <div>
          <Link
            to="/about"
            className="w-[198px] h-[40px] py-[1.38px] flex items-center px-[16px] font-medium font-inter  text-base rounded-[22.96px] bg-gradient-to-b from-[#FFFFFF] to-[#EEF4FF]  md:rounded-[34.38px] md:py-[2px]"
            style={{
