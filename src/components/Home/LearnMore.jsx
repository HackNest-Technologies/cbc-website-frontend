...
const LearnMore = () => (
  <section className="container mx-auto pt-16 sm:pt-26 flex p-6 gap-2 md:px-0 md:gap-3">
    ...
    <div className="flex-1 space-y-4 pt-1.5 lg:max-w-[1081px] 2xl:max-w-[1400px]">
      ...
      <div>
        <Link
          to="/about"
          className={`border w-[120px] flex justify-center items-center border-[#989898] bg-gradient-to-b from-[#FFFFFF] to-[#EEF4FF]  rounded-[100px] font-medium font-inter px-4 py-2 text-sm hover:cursor-pointer active:scale-95 transition-transform sm:rounded-[50px] sm:w-[180px] sm:h-[58px] md:w-[220px]`}
        >
          Learn More
		</Link>
      </div>
