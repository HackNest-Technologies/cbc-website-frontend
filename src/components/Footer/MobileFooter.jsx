    ...
    <section className="md:hidden">
      <div className="relative overflow-">
        ...
        <div className="w-full">
          ...
          <div className="w-full absolute bottom-0 left-[-20px] overflow-hidden">
            <div className="translate-y-[15px]">
              <h1 className="font-satoshi stroke-white-mobile text-transparent text-[clamp(3rem,5vw,50px)] leading-[clamp(2.5rem,6vw,58px)] capitalize tracking-wide">
                Calvary Bible
              </h1>
              <h1
                className="font-satoshi stroke-white-mobile text-transparent text-[clamp(3rem,5vw,50px)] leading-[clamp(2.5rem,6vw,58px)] capitalize tracking-wide" >
                Church
              </h1>
            </div>
          </div>
          ...
          {/* Footer links */}
          <footer className="absolute top-[40px] left-0 right-0 bottom-0 z-10">
            <MobileList />
          </footer>
        </div>
      </div>
