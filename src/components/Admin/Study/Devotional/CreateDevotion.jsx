...
import { useCreateDevotionalMutation } from "../../../../redux/apiSlice";
...
const CreateDevotion = () => {
  ...
  const [createDevotional, { isLoading }] = useCreateDevotionalMutation();
  ...
  const [devotionData, setDevotionData] = useState(initialState);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
    await createDevotional(devotionData).unwrap();

      // Reset form
      setDevotionData(initialState);

      alert("Devotion created successfully!");

      // Redirect to devotions list
      navigate("/admin/admin-devotional");
    } catch (error) {
      console.error("Error creating devotion:", error);
      alert("Something went wrong while creating the devotion.");
    }
  };
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Fill in the details of the daily devotional you want to create
              </p>
            </div>
            ...
            <div>
              ...
              {devotionData.date && (
                <p className="mt-2 text-sm text-gray-500">
                  Selected:{" "}
                  {new Date(devotionData.date).toLocaleDateString("en-US", {
                    weekday: "long",
                    year: "numeric",
                    month: "long",
                    day: "numeric",
