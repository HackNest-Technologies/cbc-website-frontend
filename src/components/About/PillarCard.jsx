    ...
    <section className="">
      <div className="pt-16 pl-6">
        <div className="relative w-full">
          <img src={pillarCard} alt="" className="object-cover"/>
          <div className="rounded-[16px] absolute bottom-0 right-0 px-2  pr-6 w-[64%] md:top-[300px]">
            <h3 className=" text-base font-bold font-satoshi leading-[110%] md:text-[40px] md:leading-[110%] md:font-semibold ">
              Those who worship Him, must worship in spirit and in truth.
            </h3>
            <p className="text-sm text-inter text-black/70 leading-[120%] py-[5px] md:text-base md:pt-10">
        ...
        <div className="relative w-full">
          ...
          <div className="rounded-[16px] absolute top-[110px] min-[420px]:top-[140px] left-0 pl-6 w-[64%]  md:top-[300px]">
            <h3 className=" text-base font-bold font-satoshi leading-[110%] md:text-[40px]  md:font-semibold">
              Where two or three are gatthered, He is there</h3>
            <p className="text-sm text-inter text-black/70 leading-[120%] py-[8px] md:text-base md:pt-10">
