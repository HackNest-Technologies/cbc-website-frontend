        ...
        <div key={department.id} className="relative rounded-[14.154px] overflow-hidden py-10 md:flex md:gap-6  ">
          ...
          <div className="md:w-4/6">
            ...
            <a
              ...
              hover:shadow-[0_16px_20px_0_rgba(255,185,30,0.4),0_6px_10px_0_rgba(255,225,159,0.4)] lg:absolute bottom-[15px] lg:gap-3 shadow-[0px_3px_8px_0px_#FFE19F47] md:shadow-[0px_14px_14px_0px_#FFB91E47] h-[52px] w-[212px] rounded-[200px] border-[#8c99ff] py-[16px] px-[24px]"
            >
