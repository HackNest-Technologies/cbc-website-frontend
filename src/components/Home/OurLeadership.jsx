...
const OurLeadership = () => (
  <section className="container mx-auto p-6 space-y-[32.14px] md:p-0 md:pt-[80px]">
    ...
    <div className="pastor-bg bg-[#E5E5E5] py-[14.68px] px-[16px]  rounded-[7.35px] space-y-4 sm:flex sm:flex-row-reverse justify-between md:py-[22px] md:px-[44px] sm:gap-4  md:w-full lg:px-[64px] lg:py-[32px] lg:h-[540px]">
      <div className="lg:w-[45%]">
        <img
          src={pastorAndWife}
          alt="Pastor and his wife"
          className="pastor-image object-cover rounded-[9.18px] md:w-[350.56px] md:h-[381.56px] sm:translate-y-[80%] md:translate-y-[65%] lg:rounded-[20px] lg:w-[90%]  lg:h-[118%] lg:translate-y-[11%]"
        />
      </div>

      <div className="space-y-4 sm:space-y-8 lg:space-y-0 flex-1 md:flex flex-col justify-between lg:justify-normal">
        <h4 className="font-satoshi capitalize leading-tight text-[clamp(14px,2.2vw,32px)]">
          pastor olumide emmanuel
        </h4>

        {/* <p className="leader-paragraph text-sm font-inter leading-[120%] md:text-base lg:w-[472px] lg:py-[40px] "> */}
        <p className="font-inter leading-relaxed text-[clamp(14px,0.8vw,16px)] lg:max-w-[clamp(280px,40vw,572px)] py-[clamp(12px,4vh,40px)]">
        ...
        <div>
          <Link
            to="/leadership"
            className="inline-flex items-center justify-center font-inter font-medium text-[clamp(14px,1.2vw,18px)] h-[clamp(40px,6vh,58px)] px-[clamp(16px,2vw,32px)] rounded-[clamp(22px,3vw,34px)] bg-gradient-to-b from-[#FFFFFF] to-[#EEF4FF] transition-transform active:scale-95"
            style={{
