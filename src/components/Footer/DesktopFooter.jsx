...
//         {/* Logo */}
//         <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 rounded-full lg:top-[10px] xl:top-[10px] 2xl:top-[20px]">
//           <img
//             src={logo}
//             alt="Logo"
...
//           </svg>
//           {/* Nav links */}
//           {/* <nav className="absolute top-[250px] left-0 w-full flex justify-center gap-12 text-white text-lg font-medium z-10">
//             <a href="#">About</a>
//             <a href="#">Watch & Listen</a>
//             <a href="#">Community</a>
//             <a href="#">Learning</a>
//             <a href="#">Arms of Trucalms</a>
//           </nav> */}
//           <footer className="absolute top-[250px] left-0 right-0 bottom-0 z-10">
//             <FooterList />
//           </footer>
//         </div>
//       </div>
