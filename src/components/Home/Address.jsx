  ...
  return (
    <section className="container mx-auto sm:mx-0 mt-14 sm:mt-24 md:pt-[90px] xl:pt-[250px] 2xl:pt-[150px]">
      <div className="bg-[#FFB91E47] mr-14 p-6 pr-12 pt-12 sm:py-20 relative rounded-r-[11.27px] space-y-4 md:rounded-r-[30px] lg:py-[67px] lg:px-[6.5vw]">
        ...
        <address className="text-sm font-satoshi leading-[145%] not-italic sm:text-[32px] lg:text-[30px] xl:text-[48px] lg:w-[656px] xl:w-[1000px] ">
          {address}
        </address>
        <a
          href={googleMapsLink}
          ...
          className="flex items-center gap-2 text-[10px] leading-[150%] underline text-[#333333] font-inter sm:text-2xl lg:text-base lg:w-[220px] xl:text-[24px]"
        >
