...
const NewConvertBg = () => {
  return (
    <section>
      ...
      <div className="px-6 pt-[65px] md:flex md:justify-center md:pt-[75px] lg:pt-[90px]">
        <h2 className="text-[24px] text-center leading-[120%] font-satoshi uppercase md:w-[688px] md:text-[40px] md:leading-[100%] lg:text-[60px] lg:w-[975px]">
