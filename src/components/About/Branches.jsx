...
const Branches = () => {
  ...
  return (
    <section id="branches" className="relative pb-[450px] md:pt-[250px] md:pb-[200px] lg:pt-[430px] lg:pb-[400px]">
      <div className="branchBg bg-[rgba(255,185,30,0.28)] h-[220px] md:h-[408px] md:py-[67px]">
        <div className="flex flex-col items-center">
          <div className="w-[262px] pt-6 pb-5 md:w-[689px] lg:w-full">
            <h2 className="bear-text text-xl text-center font-satoshi font-semibold lg:text-[52px] lg:leading-[100%]">
              Explore Our Branches and Fellowships
            </h2>
            <p className="branch-paragraph text-sm text-center font-inter text-black/70 pt-[5px] leading-[120%] md:text-base lg:text-[24px] lg:leading-[30px] lg:pt-10">
