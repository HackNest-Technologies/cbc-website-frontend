...
const ConfirmModal = ({ isOpen, onClose, onConfirm,msg }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
      <div className="w-[453px] h-[] bg-white p-[15px] rounded-[15px] shadow-lg">
        ...
        <p className="mb-4 font-inter text-base text-center pt-3">This can't be undone, this blog post would be removed from the blog.</p>
