...
const Pillars = () => {
  ...
  return (
    <>
    <section className="px-6  container mx-auto md:px-0 md:pt-20">
      <div>
        <h2 className="font-semibold font-satoshi text-xl leading-[100%] md:text-[40px]">
          7 Pillars of Calvary
        </h2>
        <p className="font-inter text-sm leading-[120%] py-6 capitalize md:text-base md:leading-[20px]">
...
{pillarsData.map((pillar) => (
        ...
        >
          <div className="w-[230px] min-[420px]:w-[280px]">
            <h2 className="font-satoshi text-base text-[#0B0A0F] pb-3 md:text-xl md:leading-[22px]">
              {pillar.title}
            </h2>
            <p className="text-inter text-sm  text-[#474747]">
              {pillar.description}
            </p>
          </div>
