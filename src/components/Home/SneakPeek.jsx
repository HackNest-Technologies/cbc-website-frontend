...
const SneakPeek = () => (
  ...
  <section className="hidden lg:block w-full pb-[250px] pt-[100px] md:pb-[50px] lg:pt-[180px] xl:pt-[310px] 2xl:pt-[150px]">
    <section className="relative">
     {/* <div className=" sneak-absolute absolute inset-0 top-[-80px]  pt-[18px]"> */}
          <div className=" sneak-absolute py-[18px]">

         <h2 className="sneakpeek-text text-[39.58px] leading-[100%] uppercase font-satoshi text-center font-bold  md:text-[105.88px] lg:text-[100px]">
           Sneak peek
        </h2>
       </div>
      <motion.section
        className="flex gap-[9px] md:gap-[10px]"
        animate={{ x: [0, "-100%"] }}
      ...
      >
        {sneekPeak.map((item,index) => (
          ...
          key={index}
            src={item}
            className="w-[107px] h-[202px] min-[400px]:h-[207px] object-cover rounded-[3.95px] md:w-[287px] md:h-[370px] md:rounded-[10.57px]"
          />
        ))}
      </motion.section>
    </section>
  ...
  <section className="lg:hidden w-full pb-[250px] pt-[100px] md:pb-[600px] lg:pt-[180px] xl:pt-[200px] 2xl:pt-[150px]">
    <section className="relative">
